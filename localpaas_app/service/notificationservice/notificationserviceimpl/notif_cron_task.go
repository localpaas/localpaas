...
func (s *service) EmailSendCronTaskNotification(
	ctx context.Context,
	db database.IDB,
	data *notificationservice.EmailMsgDataCronTaskNotification,
) error {
...
func (s *service) SlackSendCronTaskNotification(
	ctx context.Context,
	db database.IDB,
	data *notificationservice.SlackMsgDataCronTaskNotification,
) error {
...
func (s *service) DiscordSendCronTaskNotification(
	ctx context.Context,
	db database.IDB,
	data *notificationservice.DiscordMsgDataCronTaskNotification,
) error {
