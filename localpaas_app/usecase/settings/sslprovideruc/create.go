...
func (uc *UC) CreateSSLProvider(
	ctx context.Context,
	auth *basedto.Auth,
	req *sslproviderdto.CreateSSLProviderReq,
) (*sslproviderdto.CreateSSLProviderResp, error) {
	...
	return &sslproviderdto.CreateSSLProviderResp{
		Data: resp.Data,
	}, nil
}
