...
func (uc *SystemCleanupUC) GetSystemCleanupTaskLogs(
	ctx context.Context,
	auth *basedto.Auth,
	req *systemcleanupdto.GetSystemCleanupTaskLogsReq,
) (*systemcleanupdto.GetSystemCleanupTaskLogsResp, error) {
	...
	return &systemcleanupdto.GetSystemCleanupTaskLogsResp{
		Data: &systemcleanupdto.SystemCleanupTaskLogsDataResp{
			Logs:          resp.Logs,
