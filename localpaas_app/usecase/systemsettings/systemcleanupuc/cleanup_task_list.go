...
func (uc *SystemCleanupUC) ListSystemCleanupTask(
	ctx context.Context,
	auth *basedto.Auth,
	req *systemcleanupdto.ListSystemCleanupTaskReq,
) (*systemcleanupdto.ListSystemCleanupTaskResp, error) {
	...
	return &systemcleanupdto.ListSystemCleanupTaskResp{
