...
func (h *Handler) ListImageBuild(ctx *gin.Context) {
...
func (h *Handler) GetImageBuild(ctx *gin.Context) {
...
func (h *Handler) CreateImageBuild(ctx *gin.Context) {
...
func (h *Handler) UpdateImageBuild(ctx *gin.Context) {
...
func (h *Handler) UpdateImageBuildMeta(ctx *gin.Context) {
...
func (h *Handler) DeleteImageBuild(ctx *gin.Context) {
