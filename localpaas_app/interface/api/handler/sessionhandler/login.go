...
func (h *Handler) writeSessionDataToCookies(ctx *gin.Context, sessionResp *sessiondto.BaseCreateSessionResp,
...
func (h *Handler) clearSessionDataFromCookies(ctx *gin.Context) {
