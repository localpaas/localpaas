...
// @Success 200 {object} appdto.GetAppStorageSettingsResp
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/apps/{appID}/storage-settings [get]
func (h *AppHandler) GetAppStorageSettings(ctx *gin.Context) {
	...
	req := appdto.NewGetAppStorageSettingsReq()
	...
	resp, err := h.appUC.GetAppStorageSettings(h.RequestCtx(ctx), auth, req)
	if err != nil {
		h.RenderError(ctx, err)
		return
	}
...
// @Param   projectID path string true "project ID"
// @Param   appID path string true "app ID"
// @Param   body body appdto.UpdateAppStorageSettingsReq true "request data"
// @Success 200 {object} appdto.UpdateAppStorageSettingsResp
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/apps/{appID}/storage-settings [put]
func (h *AppHandler) UpdateAppStorageSettings(ctx *gin.Context) {
	...
	req := appdto.NewUpdateAppStorageSettingsReq()
	req.ProjectID = projectID
	req.AppID = appID
	...
	resp, err := h.appUC.UpdateAppStorageSettings(h.RequestCtx(ctx), auth, req)
	if err != nil {
		h.RenderError(ctx, err)
		return
	}
