...
func (h *ProjectHandler) ListCloudStorage(ctx *gin.Context) {
...
func (h *ProjectHandler) GetCloudStorage(ctx *gin.Context) {
...
func (h *ProjectHandler) CreateCloudStorage(ctx *gin.Context) {
...
func (h *ProjectHandler) UpdateCloudStorage(ctx *gin.Context) {
...
func (h *ProjectHandler) UpdateCloudStorageMeta(ctx *gin.Context) {
...
func (h *ProjectHandler) DeleteCloudStorage(ctx *gin.Context) {
