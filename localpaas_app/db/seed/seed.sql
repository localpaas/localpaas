...
VALUES ('01JAB9XED0GTXBSQDFVYAJ8WE1', 'oauth', 'github', 'Github', 'active',
       ...
       ('01JAB9XED0GTXBSQDFVYAJ8WK1', 'git-token', 'github', 'localpaas-test', 'active',
        '{"user": "tiendc85", "token": "lpsalt:Zw7McGVDyzkt3A== YoU4zm6uR4RUuGktyllHWZL7JY5u2kUp6ruRHveSySw62iCq/nxqUkANPHl6tzOd6RcGaoj+KEmZ3qjmMi+f2s/7IpGXK3x4RpjckkkXqE0eUZxgzPZR3LtoSDJte8jk2WVN+lB+AwKKAhRwsKR783FRhP758w4pEw=="}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WK2', 'git-token', 'gitlab', 'localpaas-test', 'active',
        '{"user": "tiendc85", "token": "lpsalt:4qZn6J1Uv2ZZwg== OPpYl2RHwiWytl9DGZ/AuPjLQsDgoFjN3PuDMQPH/Lz3zogltW3Vad/dKfiLHTsl6NCeJ9BLCX/Y82x5As1a9XPt9uGChjFfTb+ftRG5aT8KMcs2LQ=="}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00')
ON CONFLICT DO NOTHING;
