...
VALUES ('01JAB9XED0GTXBSQDFVYAJ8WE1', 'oauth', 'github', 'Github', 'active',
       ...
       ('01JAB9XED0GTXBSQDFVYAJ8WE6', 'registry-auth', 'docker.com', 'docker.com 1', 'active',
        '{"address": "docker.com", "password": "lpsalt:7rJsK4//cIqCKw== SxnfW00e9UueetjGT0dpuC9pUqqWR3fEiX1w+YZAo6N4E9+bNp3itGnvWR5tyblz1lJwjWAXnleyXiqtk4Rxsw==", "username": "localpaastest"}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WE7', 'registry-auth', 'docker.com', 'docker.com ro', 'active',
        '{"address": "docker.com", "password": "lpsalt:xpbKUbDCp7mDbQ== zzzou62KRIRxm5mfg4FFWivJGaVH19FhuglZa2bfOAhM7UDsxfCx2Z4HnRJUOqSPv3Nc/AEb9iCzrFzvd5sFNA==", "username": "localpaastest"}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00')
ON CONFLICT DO NOTHING;
