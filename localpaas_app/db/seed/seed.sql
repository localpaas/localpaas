...
-- Settings: Providers
INSERT INTO settings (id, type, kind, name, status, avail_in_projects, is_default, data, created_at, updated_at)
VALUES ('01JAB9XED0GTXBSQDFVYAJ8WE1', 'oauth', 'github', 'Github', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WE2', 'oauth', 'gitlab', 'Gitlab', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WE3', 'oauth', 'gitlab', 'Our Gitlab', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WE4', 'oauth', 'gitea', 'Gitea', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WE5', 'oauth', 'google', 'Google', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WF1', 'ssh-key', NULL, 'ssh-key srv 2', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WF2', 'ssh-key', NULL, 'ssh-key srv 2 with passphrase', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WG1', 'registry-auth', 'docker.io', 'docker.io 1', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WG2', 'registry-auth', 'docker.io', 'docker.io ro', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WH1', 'im-service', 'slack', 'slack 1', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WI1', 'im-service', 'discord', 'discord 1', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WJ1', 'github-app', 'github-app', 'github-app localpaas-test', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WK1', 'access-token', 'github', 'github token localpaas-test', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WK2', 'access-token', 'gitlab', 'gitlab token localpaas-test', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WK3', 'access-token', 'gitlab', 'gitlab custom token localpaas-test', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WK4', 'access-token', 'gitea', 'gitea token localpaas-test', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WL1', 'basic-auth', '', 'basic auth 1', 'active', true, true,
        '{"username": "admin", "password": "lpsalt:DGXrPb7G9lJ8LQ== 4xqN58+MerC2JDkrCvUGVamF+JhzuRo30bRWuVXltNW/Xg=="}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WL2', 'basic-auth', '', 'basic auth 2', 'active', true, true,
        '{"username": "admin", "password": "lpsalt:xDd5Ce/pyGR8JA== 0emZ9l7PhuKom1qS5vmBKx2TNiqhbbEhqgBe7VDTzAGAGrT/"}',
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WM1', 'ssl', 'letsencrypt', 'ssl 1', 'active', true, true,
        ...
        '2025-10-01 00:00:00', '2025-10-01 00:00:00'),
       ('01JAB9XED0GTXBSQDFVYAJ8WM2', 'ssl', 'letsencrypt', 'ssl 2', 'active', true, true,
